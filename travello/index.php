                                ...
                                <form action="search.php" method="post" class="home_search_form" id="home_search_form">
                                    <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                        <div class="form-group dropdown">                            
                                            <select class="form-control search_input mt-2 p-2" placeholder="city" name="city" id="exampleFormControlSelect1">
                                            <?php
                                        ...
                                        <div class="form-group dropdown">                            
                                            <select class="form-control search_input mt-2 p-2" placeholder="price" name="price" id="exampleFormControlSelect1">
                                            <?php
                                                $connect = mysqli_connect('localhost', 'root', '', 'travelo');
                                                $query = "SELECT * FROM place";
                            ...
                            <div class="newsletter_form_container">
                                <form action="#" class="newsletter_form d-flex flex-md-row flex-column align-items-start justify-content-between" id="newsletter_form">
                                    <div class="d-flex flex-md-row flex-column align-items-start justify-content-between">
                                        <div><input type="text" class="newsletter_input newsletter_input_name" id="newsletter_input_name" placeholder="Name" required="required">
                                            <div class="input_border"></div>
                                        </div>
                                        <div><input type="email" class="newsletter_input newsletter_input_email" id="newsletter_input_email" placeholder="Your e-mail" required="required">
                                            <div class="input_border"></div>
                                        </div>
                                    </div>
