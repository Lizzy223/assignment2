...
<?php include "includes/navigation.php" ?>
        ...
        <?php  
            ...
            $query = " SELECT * FROM admin_signin WHERE email = '{$email}'";
                                        ...
                                        <div class="home_slider_content">
                                            <div class="home_title">
                                                <div class="col-md-6 mx-auto mt-5 p-3 class" style="width: 50%;">
                                                    ...
                                                    <hr>
                                                    <small class="mr-5" style="color: black;">Don't have an account yet, <a href="admin_signin.php" class="btn btn-primary">Sign Up</a></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
